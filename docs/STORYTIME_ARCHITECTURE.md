...
```
┌──────────────────────────────────────────────────────────────┐
│ 📜 PROSE NARRATOR (qwen2.5-coder:7b)                        │
├──────────────────────────────────────────────────────────────┤
│ In the beginning, there was only an empty repository. The   │
│ first commit planted the seed of infrastructure—skills,     │
│ tooling, a scaffold for what would become the garden...     │
└──────────────────────────────────────────────────────────────┘

┌──────────────────────────────────────────────────────────────┐
│ 🎤 RAP NARRATOR (llama3.1:8b)                               │
├──────────────────────────────────────────────────────────────┤
...
┌──────────────────────────────────────────────────────────────┐
│ 🎋 HAIKU NARRATOR (tinyllama)                               │
├──────────────────────────────────────────────────────────────┤
│ Empty repository                                             │
│ First commit plants the first seed                           │
│ Garden begins                                                │
└──────────────────────────────────────────────────────────────┘
```
...
│     ├── git log → History                                  │
│     └── .clood/personality.yaml → Project personality      │
│                                                             │
│  2. SCENE SELECTION                                         │
...
│                                                             │
│  5. OUTPUT                                                  │
│     ├── --flying-cats → Full narrative                     │
│     ├── --haiku → Subtle decoration                        │
...
Storytime makes clood memorable. Not every user wants narrative mode—but those who do will never forget it.
