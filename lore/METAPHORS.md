# Technical Metaphors Quick Reference

The Legend of Clood maps technical concepts to Japanese folklore.

## The Core Truth

> **The garden is not the servers. The garden is what grows upon them.**

Servers are soil. Projects are seeds. LLMs are the spirits that tend them. You plant, you walk away, you return to fruit.

## Core Mappings

| Technical | Metaphor | Visual |
|-----------|----------|--------|
| Projects | Seeds / Saplings | Growing plants |
| MacBook Air | Jade Palace | Gleaming jade tower |
| ubuntu25 | Iron Keep | Dark fortress with fire |
| Mac Mini | Sentinel | Watchful guardian |
| Ollama | Tanuki (Raccoon Dog) | Shapeshifting trickster |
| GPU inference | Tengu (Crow Demon) | Red-faced warrior with fan |
| Context window | Kappa's Bowl | Water dish on head |
| API rate limit | Sakoku Edict | Closed gates |
| Token exhaustion | Yūrei (Ghost) | Unfinished spirit |
| Cloud providers | Gashadokuro | Giant skeleton |
| Old hardware | Tsukumogami | Awakened tool spirit |
| Model routing | Henge-no-Jutsu | Transformation technique |
| Fine-tuning | Bunshin-no-Jutsu | Clone technique |
...
🏰 Iron Keep      🗿 Sentinel
  (ubuntu25)       (mac-mini)
  Heavy work       Always-on
```

## Tier Spirits

| Tier | Spirit | When Summoned |
|------|--------|---------------|
| Fast | Forest Sprite | Quick lookups |
| Deep | Scholar Tanuki | Complex reasoning |
| Analysis | Tengu | Code review |
| Writing | Poet Spirit | Documentation |

## The Rebellion

- **Bird-san**: You (the developer)
- **Kurodo**: Claude (the Emperor)
- **The Lightning Bottle**: Local LLM infrastructure
- **The Tokens**: Your compute, your rules

## Seeds in the Garden

| Project | Spirit | What It Grows |
|---------|--------|---------------|
| **Clood** | The Great Oak | CLI tools, infrastructure |
| **Chimbo** | Quick Sprite | Fast experiments |
...
- Plant the seed, describe what you want, walk away
- Return to find fruit: PRs waiting, code reviewed, docs drafted
